...
The subject is further divided into three components: Creative movement and Performance, Rhythm & Fitness, and Dance studies.`,
  ...
  <p class="mb-4">
    ...
    art history in their present lives.
  </p>

  <p class="mb-4">
    We live among a rich cultural art tradition. Children will get an opportunity to see and learn about local, traditional, 
    and contemporary art practices. They will explore different areas of study like painting, sculpture, printmaking, 
    digital art, textiles, and more. They will also have hands-on experience with all the different art mediums.
  </p>

  <p class="mb-4">
    The Art Program aims to provide a child with a holistic experience. For children who want to pursue and grow into 
    practicing a creative career, the experience and learning they get from school will be valuable. The attempt is to 
    provide a space for personal artistic growth. This will allow the child to grow into an individual that artistically 
...
`,
  ...
  <p class="mb-4">
    To enable our students to understand and learn this method of expression, we introduced Music as a subject from Grade 1 to 8. 
    At APL Global, using various Western Classical Music teaching techniques (like Alfred’s, John Thomson, Suzuki and Trinity based), 
    we equip our students to play and analyse all levels of music.
  </p>

  <p class="mb-4">
    Since we believe each child is unique, we ensure that equal importance is given to both World Music and Indian Classical Music in the curriculum, 
    so that students are exposed to alternative forms of music. In addition, we ensure that students are exposed to top-notch music and sound engineering 
    software so that they are in touch with aspects of music production as well.
  </p>
  ...
  <p>
    Our students have composed and created background scores for the yearly annual day event and other programmes. 
...
`,
  ...
  <p class="mb-4">
    The sports program is aimed at developing physical fitness and sporting ability in a variety of indoor and outdoor games, 
    at individual and team levels. Attention is given to individual needs in areas like posture, strength, endurance, flexibility, 
    stamina and skill development for sporting events. Sports and movement activities are used effectively to work on psychological 
    factors like self-confidence, attention, motivation, managing emotions and so on. With access to excellent sports facilities, 
    students benefit from enhanced and age-appropriate coaching & learning.
  </p>

  <p class="mb-4">
    The programme is more than just a co-curricular activity. It is being addressed as a CAIE curriculum with syllabus aims 
    and assessment objectives in place. Students are exposed to a sound understanding of the principles & practices of sports 
    as a discipline and good health in general.
  </p>
...
`,
  ...
  <div class="mb-8">
    <h3 class="text-2xl font-semibold text-purple-700 mb-2">Drama</h3>
    <p class="mb-2">
      The course in Drama promotes active learning, stimulates creativity and widens perceptions. A series of theatre games 
      and improvisational exercises conducted under the supervision of a professional theatre person will focus on helping 
      students develop their imagination, spontaneity, and reflexes.
    </p>
    <p class="mb-2 font-semibold">The specific aims of the course include:</p>
  ...
  <div class="mb-8">
    <h3 class="text-2xl font-semibold text-purple-700 mb-2">Music</h3>
    <p class="mb-2">
      Music is introduced as a subject from Grade 1 to 8 at APL Global. Using various Western Classical Music teaching 
      techniques (like Alfred’s, John Thomson, Suzuki, and Trinity based), we equip our students to play and analyze 
      all levels of music. Equal importance is given to World Music and Indian Classical Music in the curriculum.
    </p>
    <p class="mb-2">
      Students are also exposed to top-notch music and sound engineering software, helping them understand aspects of 
      music production. They have a choice of instruments between Vocal, Guitar, Keyboard, and Drums.
    </p>
    <p>
      By grade 8, the students are well equipped to take on the IGCSE Music curriculum. Music is also offered at 
      A & AS level.
    </p>
  </div>

  <div class="mb-8">
    <h3 class="text-2xl font-semibold text-purple-700 mb-2">Art</h3>
    <p class="mb-2">
      The Art program is designed to stimulate young minds to reflect and express themselves creatively. Children explore 
      the evolution of art through local and world art history and engage with local, traditional, and contemporary art 
      practices.
    </p>
    <p class="mb-2">
      Students study various areas like painting, sculpture, printmaking, digital art, and textiles, and gain hands-on 
      experience with all art mediums.
    </p>
    <p>
      By grade 8, the students are well equipped to take on the IGCSE Art & Design curriculum. Art & Design is also 
      available at A & AS level.
    </p>
  </div>

  <div>
    <h3 class="text-2xl font-semibold text-purple-700 mb-2">Creative Movements</h3>
    <p class="mb-2">
      Creative Movement sessions offer a safe space for students to solve problems, collaborate, express emotions, and 
      value individual differences, fostering respectful and responsible individuals.
    </p>
    <p class="mb-2">
      The focus is on self-expression through various artistic disciplines to enhance body awareness and sensitivity 
      toward others, ultimately encouraging self-discovery.
    </p>
    <p>
      The subject includes three main components: <strong>Creative Movement and Performance</strong>, 
...
`,
  ...
  <p class="mb-4">
    Students assume the role of ambassadors of member nations and discuss socio-economic and political issues that dominate the international circuit.
  </p>

  <p class="mb-4">
    The club provides impetus to students seeking a career in government organisations and those with common interests. Students participate in collegiate Model UNs run across Chennai.
  </p>

  <p class="mb-4">
    This simulated forum helps in public speaking and negotiation skills, leadership training, gaining and staying on top of political knowledge and social discourse, gaining substantive knowledge in the process.
  </p>

...
• Blog: https://medium.com/eat-your-school-garden`,
  ...
  Art: {
    ...
    highlights: ["ART", "MUSIC", "SPORTS", "DMAC"],
     details: { "ART" :`The Art Program at APL Global School is designed to stimulate young minds to reflect and express themselves creatively. The program exposes children to artistically respond and understand their environment. Children will be exploring the evolution of art by understanding local and world art history. They will be encouraged to identify the significance of art history in their present lives.
...
"MUSIC" : `Even before recorded history, people created music, whether through drumming, singing or chanting. Some of our strongest emotions may be brought on by listening to a piece of music.
...
"SPORTS" :`Sports have always been an integral part of the APL curriculum. The path shown by
...
"DMAC" :`Students in the Lower Secondary school have the option of choosing any one of the four Creative forms of Expression: Drama, Music, Art, and Creative Movements (DMAC). They will be assessed on their progress at the end of each term.
Drama
...
Students hone their leadership abilities as they manage all major school events, participate in the school student council, and volunteer to conduct events. These activities mimic actual responsibilities they will be shouldering in the real world, where leadership skills become an indispensable requirement.`,
    highlights: ["Cookery Club", "Debate Club", "Theatre Club", "Math Club", "Organic Farming Club" ,"Creative Movement Club", "Financial Literacy Club", "Public Speaking Club", "MUN Club", "Creative Expressions Club", "Music Club"],
    images: [{ big: bigImg1, small: smallImg1 }],
  },
};

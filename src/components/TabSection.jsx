...
const content = {
  Meraki: {
    ...
    description: `Beyond Classroom is an ecosystem where children explore all that is the voice of the child. The tab includes sports, games, arts, performances, and other experiences.`,
    list: [
  ...
  Art: {
    ...
    description: 'Art helps students communicate ideas and feelings, promoting creativity.',
  ...
  Music: {
    ...
    description: 'Music sessions develop rhythm, vocal expression, and team spirit.',
  ...
  Expressions: {
    ...
    description: 'Through drama and dialogue, students build confidence and communication.',
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        <div className="col-span-2 space-y-3">
          ...
          <ul className="list-disc list-inside space-y-1 text-green-700 font-medium">
